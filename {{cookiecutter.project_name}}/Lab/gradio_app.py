...
import openai         # OpenAI API for accessing ChatGPT models
...
def main(cfg: DictConfig):
    ...
    iface = gr.Interface(
        ...
        inputs=[
            ...
            gr.inputs.Textbox(lines=2, label="System Instruction", default="You are a helpful assistant."),
            gr.inputs.Textbox(lines=2, label="User Prompt")
        ],
